...
updated: 2026-06-01T10:37:42.949Z
---
...
Codemaps 是由 **Codex SWE-1** 和 **Claude Sonnet 4** 驱动的、首个 AI 注释的结构化代码地图系统，由 Cognition（Devin 团队）推出，集成在 Windsurf IDE 中。
